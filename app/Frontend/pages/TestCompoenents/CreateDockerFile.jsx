...
const CreateDockerFile = () => {
  const [InputDockerfile, setInputDockerfile] = useState(`FROM ubuntu:latest
RUN apt-get update
...
`);
  ...
  const handleDockerInput = async () => {
    ...
    // setInputDockerfile(""); // Clearing the input is optional, depending on your requirements
  };
            ...
            <div className="text-center mt-3">
              ...
              <button
                className="mt-1 px-5 font-bold text-sm text-white bg-blue-500 rounded
                        hover:bg-blue-700 disabled:bg-gray-400 cursor-default"
