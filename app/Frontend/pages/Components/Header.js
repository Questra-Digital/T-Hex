        ...
        <nav class="p-5 bg-blue shadow md:flex md:items-center md:justify-between bg-sky-900">
            ...
            <ul
                ...
                <li class="mx-4 my-6 md:my-0 ">
                    <Link to="/HomePage" class="text-l text-slate-50 hover:text-cyan-500 duration-500">Home</Link>
                </li>
                <li class="mx-4 my-6 md:my-0">
                    <Link to="/StartTest" class="text-l text-slate-50 hover:text-cyan-500 duration-500">StartTest</Link>
                </li>
                <li class="mx-4 my-6 md:my-0">
                    <Link to="/Debugging" class="text-l text-slate-50 hover:text-cyan-500 duration-500">Debugging</Link>
                </li>
                <li class="mx-4 my-6 md:my-0">

                    <Link to="/Settings" class="text-l text-slate-50 hover:text-cyan-500 duration-500">Settings</Link>

                </li>

                <a href="http://localhost:4455/self-service/logout?token=CucL1g9LEiHZAUuL9iMoD7yvPXvZG8qL">
